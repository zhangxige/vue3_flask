   ...
   <el-container class="main-container">
    ...
    <el-main class="content" @scroll="handleScroll">
        ...
        <article ref="articleRef">
            <h2 id="toc-1">一级标题</h2>
            <h3 id="toc-1-1">1.1 分标题</h3>
            <p>段落内容：1234567</p>
            <div class="demo-image__placeholder">
                <div class="block">
                <span class="demonstration">Default</span>
                <el-image class="hover-image"
                      :src="imgsrc"
                      :zoom-rate="1.2"
                      :max-scale="7"
                      :min-scale="0.2"
                ...
                <el-image :src="imgsrc" class="zoom-on-hover">
            ...
            <h2 id="toc-3">三级标题</h2>
                <el-upload
                    ...
                    action="http://127.0.0.1:5000/alg/alg3"
    ...
    <el-aside width="150px">
      <div class="toc-container">
        <h3 class="toc-heading mb-15">导航索引  </h3>
        <ul class="toc-items">
...
<script setup lang="ts">
    ...
    const generateTOC = () => {
      if (!articleRef.value) return;
          ...
          tocList.value = Array.from(headings).map(heading => ({
            ...
            level: parseInt((heading as HTMLElement).tagName.substring(1))
          }))
        }
    }
    ...
    const scrollTo = async (id: string) => {
      ...
      if (target) {
        ...
        await new Promise<void>(resolve => {
            ...
            const scrollContainer = parent && parent.parentElement;
            if (scrollContainer) {
    ...
    const imgsrc = 'https://cdn.bigmodel.cn/static/platform/images/usage-guide/cogvideo/1.png'
    // const imgsrc = 'http://127.0.0.1:5000/alg/upload/test.jpg'
    const srcList = [
        'https://cdn.bigmodel.cn/static/platform/images/usage-guide/cogvideo/1.png',
        'https://cdn.bigmodel.cn/static/platform/images/usage-guide/cogvideo/2.png',
        'https://cdn.bigmodel.cn/static/platform/images/usage-guide/cogvideo/3.png',
    ]
...
.hover-image:hover {
  /* opacity: 0.8; 改变透明度 */
  border: 1px solid #335a81; /* 改变边框颜色 */
}
</style>
